...
(function () {
  ...
  this.Waves = function (xiantiaobeijing, options) {
    var Waves = this;
    ...
    Waves.xiantiaobeijing = document.querySelector(xiantiaobeijing);
    Waves.canvas = document.createElement('canvas');
    Waves.ctx = Waves.canvas.getContext('2d');
    Waves.xiantiaobeijing.appendChild(Waves.canvas);
  ...
  Waves.prototype.resize = function () {
    var Waves = this;
    var width = Waves.xiantiaobeijing.offsetWidth;
    var height = Waves.xiantiaobeijing.offsetHeight;
  ...
  Waves.prototype.updateColor = function () {
    ...
    // var a = Math.floor(127 * Math.sin(0.3 * Waves.hue + 0) + 300);
    // var b = Math.floor(127 * Math.sin(0.3 * Waves.hue + 2) + 300);
    // var c = Math.floor(127 * Math.sin(0.3 * Waves.hue + 4) + 300);

    Waves.color = 'rgba(64, 158, 255, 0.01)';
  };
...
var waves = new Waves('.xiantiaobeijing', {
  fps: true,
  waves: 3,
  width: 200,
});
